...
func NewBadRequestError(message string) *AppError {
	return New(ErrCodeValidationFailed, "Bad Request", message)
}

func NewUnauthorizedError(message string) *AppError {
	return New(ErrCodeUnauthorized, "Unauthorized", message)
}

func NewForbiddenError(message string) *AppError {
	return New(ErrCodeForbidden, "Forbidden", message)
}

func NewNotFoundError(message string) *AppError {
	return New(ErrCodeRecordNotFound, "Not Found", message)
}

func NewInternalServerError(message string) *AppError {
	return New(ErrCodeInternalError, "Internal Server Error", message)
}

func NewValidationError(message string) *AppError {
	return New(ErrCodeValidationFailed, "Validation Failed", message)
}

func NewDatabaseError(err error) *AppError {
	return Wrap(err, ErrCodeDatabaseError, "Database Error", err.Error())
}

func NewExternalServiceError(message string) *AppError {
	return New(ErrCodeExternalServiceError, "External Service Error", message)
}

func NewRateLimitError() *AppError {
	return New(ErrCodeRateLimitExceeded, "Rate Limit Exceeded", "Too many requests")
}
